...
const Home = () => {
  ...
  const fetchData = async () => {
    try {
      const res = await axios.get(
        "https://backend-zi01.onrender.com/api/products/"
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(
        `https://backend-zi01.onrender.com/api/products/edit/${editProduct._id}`,
        formData
      );
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(
        `https://backend-zi01.onrender.com/api/products/delete/${deleteProduct._id}`
      );
